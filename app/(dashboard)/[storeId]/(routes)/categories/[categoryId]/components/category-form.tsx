...
export const CategoryForm: React.FC<CategoryFormProps> = ({
  ...
  const title = initialData ? 'Edita Categoria.' : 'Crea Categoria';
  const description = initialData ? 'Edita Categoria.' : 'Agrega una nueva Categoria.';
  const toastMessage = initialData ? 'Categoria actualizada.' : 'Categoria creada.';
  const action = initialData ? 'Cambios guardados.' : 'Categoria creada.';
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select disabled={loading} onValueChange={field.onChange} value={field.value} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue defaultValue={field.value} placeholder="Seleccione una Billetera" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
